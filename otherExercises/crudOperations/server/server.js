(function (global, factory) {
            ...
            async function handle(context) {
                ...
                if (serviceName == 'admin') {
                    return ({
                        headers,
                        result
                    } = services['admin'](method, tokens, query, body));
                } else if (serviceName == 'favicon.ico') {
                    return ({
                        headers,
                        result
                    } = services['favicon'](method, tokens, query, body));
                }
    ...
    const actions = {
        ...
        post: (context, tokens, query, body) => {
            ...
            const newId = uuid$1();
            responseData[newId] = Object.assign({}, body, {
                _id: newId
            });
    ...
    function createInstance(seedData = {}) {
        ...
        function get(collection, id) {
            ...
            if (!id) {
                ...
                let result = entries.map(([k, v]) => {
                    return Object.assign(deepCopy(v), {
                        _id: k
                    });
                });
                return result;
            ...
            return Object.assign(deepCopy(entry), {
                _id: id
            });
        }
        ...
        function add(collection, data) {
            ...
            return Object.assign(deepCopy(record), {
                _id: id
            });
        }
        ...
        function query(collection, query) {
            ...
            for (let [key, entry] of [...targetCollection.entries()]) {
                ...
                if (match) {
                    result.push(Object.assign(deepCopy(entry), {
                        _id: key
                    }));
                }
            }
    ...
    function initPlugin$1(settings) {
        ...
        return function decorateContext(context, request) {
            ...
            function saveSession(userId) {
                ...
                session = context.protectedStorage.set('sessions', session._id, Object.assign({
                    accessToken
                }, session));
                return session;
            }
        ...
        return function decorateContext(context, request) {
            ...
            function canAccess(data, newData) {
                ...
                let {
                    rule,
                    propRules
                } = getRule(action, context.params.collection, data);
